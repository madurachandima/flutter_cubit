...
class RecommendedTvSeries extends StatelessWidget {
  final int tvId;

  const RecommendedTvSeries({super.key, required this.tvId});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GenericDataCubit()
        ..getData<List<TvDataEntity>>(sl<GetRecommendedTvByIdUseCase>(),
            params: tvId),
